...
class Aranet4Device extends Homey.Device {
  ...
  onAdded() {
    ...
    let added = new Date();
    this.setSettings({
      added: ("0" + added.getDate()).slice(-2) + "-" + ("0" + (added.getMonth() + 1)).slice(-2) + "-" + added.getFullYear() + " " + ("0" + added.getHours()).slice(-2) + ":" + ("0" + added.getMinutes()).slice(-2)
    });
  ...
  onInit() {
    ...
    this.setSettings({
      ...
      restarted: ("0" + restarted.getDate()).slice(-2) + "-" + ("0" + (restarted.getMonth() + 1)).slice(-2) + "-" + restarted.getFullYear() + " " + ("0" + restarted.getHours()).slice(-2) + ":" + ("0" + restarted.getMinutes()).slice(-2)
    });
  }
