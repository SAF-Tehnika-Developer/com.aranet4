...
class RadiationDevice extends Homey.Device {
  onAdded() {
    ...
    let driver = this.homey.drivers.getDriver('radiation')
    driver.synchroniseSensorData()
    console.log('Restarting Aranet Radiation synchronization sequence............')
  }
...
module.exports = RadiationDevice
